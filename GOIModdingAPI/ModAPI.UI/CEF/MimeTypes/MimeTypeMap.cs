...
namespace ModAPI.UI.CEF.MimeTypes
{
    public static class MimeTypeMap
    {
        private static readonly IDictionary<string, string> Mappings = BuildMappings();
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound)
        {
            ...
            if (Mappings.TryGetValue(mimeType, out extension))
            {
                return extension;
            }
